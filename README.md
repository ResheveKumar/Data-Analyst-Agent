...
English — built on NVIDIA NIM's OpenAI-compatible tool-calling API.
...
cp .env.example .env        # then add your NVIDIA_API_KEY (get one at build.nvidia.com)
export NVIDIA_API_KEY=your-key-here   # or use python-dotenv / direnv
